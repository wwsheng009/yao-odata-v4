...
var require_GLOBAL = __commonJS({
  "node_modules/@newdash/newdash/.internal/GLOBAL.js"(exports, module2) {
    ...
    exports.typedArrayTags[exports.float32Tag] = exports.typedArrayTags[exports.float64Tag] = exports.typedArrayTags[exports.int8Tag] = exports.typedArrayTags[exports.int16Tag] = exports.typedArrayTags[exports.int32Tag] = exports.typedArrayTags[exports.uint8Tag] = exports.typedArrayTags[exports.uint8ClampedTag] = exports.typedArrayTags[exports.uint16Tag] = exports.typedArrayTags[exports.uint32Tag] = true;
    exports.typedArrayTags[exports.argsTag] = exports.typedArrayTags[exports.arrayTag] = exports.typedArrayTags[exports.arrayBufferTag] = exports.typedArrayTags[exports.boolTag] = exports.typedArrayTags[exports.dataViewTag] = exports.typedArrayTags[exports.dateTag] = exports.typedArrayTags[exports.errorTag] = exports.typedArrayTags[exports.funcTag] = exports.typedArrayTags[exports.mapTag] = exports.typedArrayTags[exports.numberTag] = exports.typedArrayTags[exports.objectTag] = exports.typedArrayTags[exports.regexpTag] = exports.typedArrayTags[exports.setTag] = exports.typedArrayTags[exports.stringTag] = exports.typedArrayTags[exports.weakMapTag] = false;
    exports.cloneableTags = {};
    exports.cloneableTags[exports.argsTag] = exports.cloneableTags[exports.arrayTag] = exports.cloneableTags[exports.arrayBufferTag] = exports.cloneableTags[exports.dataViewTag] = exports.cloneableTags[exports.boolTag] = exports.cloneableTags[exports.dateTag] = exports.cloneableTags[exports.float32Tag] = exports.cloneableTags[exports.float64Tag] = exports.cloneableTags[exports.int8Tag] = exports.cloneableTags[exports.int16Tag] = exports.cloneableTags[exports.int32Tag] = exports.cloneableTags[exports.mapTag] = exports.cloneableTags[exports.numberTag] = exports.cloneableTags[exports.objectTag] = exports.cloneableTags[exports.regexpTag] = exports.cloneableTags[exports.setTag] = exports.cloneableTags[exports.stringTag] = exports.cloneableTags[exports.symbolTag] = exports.cloneableTags[exports.uint8Tag] = exports.cloneableTags[exports.uint8ClampedTag] = exports.cloneableTags[exports.uint16Tag] = exports.cloneableTags[exports.uint32Tag] = true;
    exports.cloneableTags[exports.errorTag] = exports.cloneableTags[exports.funcTag] = exports.cloneableTags[exports.weakMapTag] = false;
    ...
    exports.freeModule = exports.freeExports && typeof module2 == "object" && module2 && !module2.nodeType && module2;
    ...
    exports.allocUnsafe = typeof Buffer == "object" ? Buffer.allocUnsafe : void 0, exports.getPrototype = (0, overArg_1.default)(Object.getPrototypeOf, Object), exports.objectCreate = Object.create, exports.propertyIsEnumerable = exports.objectProto.propertyIsEnumerable, exports.splice = exports.arrayProto.splice, exports.spreadableSymbol = Symbol ? Symbol.isConcatSpreadable : void 0, exports.symIterator = Symbol ? Symbol.iterator : void 0, exports.symToStringTag = Symbol ? Symbol.toStringTag : void 0;
    ...
    exports.symbolProto = Symbol ? Symbol.prototype : void 0, exports.symbolValueOf = exports.symbolProto ? exports.symbolProto.valueOf : void 0, exports.symbolToString = exports.symbolProto ? exports.symbolProto.toString : void 0;
  }
});
...
var require_keys = __commonJS({
  "node_modules/@newdash/newdash/keys.js"(exports) {
    ...
    function keys(object) {
      return (0, isArrayLike_1.default)(object) ? (0, arrayLikeKeys_1.default)(object) : Object.keys(Object(object));
    }
    exports.keys = keys;
...
var require_baseMap = __commonJS({
  "node_modules/@newdash/newdash/.internal/baseMap.js"(exports) {
    ...
    function baseMap(collection, iteratee) {
      var index = -1, result = (0, isArrayLike_1.default)(collection) ? Array(collection.length) : [];
...
var require_isIterateeCall = __commonJS({
  "node_modules/@newdash/newdash/.internal/isIterateeCall.js"(exports) {
    ...
    function isIterateeCall(value, index, object) {
      ...
      if (type === "number" ? (0, isArrayLike_1.default)(object) && (0, isIndex_1.default)(index, object.length) : type === "string" && index in object) {
...
var require_equalArrays = __commonJS({
  "node_modules/@newdash/newdash/.internal/equalArrays.js"(exports) {
    ...
    function equalArrays(array, other, bitmask, customizer, equalFunc, stack) {
      ...
      let index = -1;
      let result = true;
      const seen = bitmask & COMPARE_UNORDERED_FLAG ? new SetCache_1.default() : void 0;
      ...
      while (++index < arrLength) {
        ...
        if (seen) {
          if (!(0, some_1.default)(other, (othValue2, othIndex) => {
            if (!(0, cacheHas_1.default)(seen, othIndex) && (arrValue === othValue2 || equalFunc(arrValue, othValue2, bitmask, customizer, stack))) {
  ...
  "node_modules/@newdash/newdash/.internal/baseIsEqualDeep.js"(exports) {
    ...
    function baseIsEqualDeep(object, other, bitmask, customizer, equalFunc, stack) {
      ...
      if (isSameTag && !objIsObj) {
        ...
        return objIsArr || (0, isTypedArray_1.default)(object) ? (0, equalArrays_1.default)(object, other, bitmask, customizer, equalFunc, stack) : (0, equalByTag_1.default)(object, other, objTag, bitmask, customizer, equalFunc, stack);
      }
...
var require_isKey = __commonJS({
  "node_modules/@newdash/newdash/.internal/isKey.js"(exports) {
    ...
    function isKey(value, object) {
      ...
      const type = typeof value;
      if (type === "number" || type === "boolean" || value == null || (0, isSymbol_1.default)(value)) {
        return true;
      }
...
var require_toString = __commonJS({
  "node_modules/@newdash/newdash/toString.js"(exports) {
    ...
    var symbolToString = (_a = Symbol === null || Symbol === void 0 ? void 0 : Symbol.prototype) === null || _a === void 0 ? void 0 : _a.toString;
...
var require_get = __commonJS({
  "node_modules/@newdash/newdash/get.js"(exports) {
    ...
    function get(object, path, defaultValue) {
      const result = object == null ? void 0 : (0, baseGet_1.default)(object, path);
...
var require_hasPath = __commonJS({
  "node_modules/@newdash/newdash/hasPath.js"(exports) {
    ...
    function hasPath(object, path, hasFunc) {
      ...
      return !!length && (0, isLength_1.default)(length) && (0, isIndex_1.default)(key, length) && ((0, isArray_1.default)(object) || (0, isArguments_1.default)(object));
    }
...
var require_matchesStrictComparable = __commonJS({
  "node_modules/@newdash/newdash/.internal/matchesStrictComparable.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_baseMatchesProperty = __commonJS({
  "node_modules/@newdash/newdash/.internal/baseMatchesProperty.js"(exports) {
    ...
    var matchesStrictComparable_1 = __importDefault(require_matchesStrictComparable());
    var toKey_1 = __importDefault(require_toKey());
    var COMPARE_PARTIAL_FLAG = 1;
    var COMPARE_UNORDERED_FLAG = 2;
    function baseMatchesProperty(path, srcValue) {
      ...
      return function(object) {
        ...
        return objValue === void 0 && objValue === srcValue ? (0, hasIn_1.default)(object, path) : (0, baseIsEqual_1.default)(srcValue, objValue, COMPARE_PARTIAL_FLAG | COMPARE_UNORDERED_FLAG);
      };
    }
    ...
    function baseIsMatch(object, source, matchData, customizer) {
      ...
      while (++index < length) {
        ...
        if (noCustomizer && data[2]) {
          ...
          if (!(result === void 0 ? (0, baseIsEqual_1.default)(srcValue, objValue, COMPARE_PARTIAL_FLAG | COMPARE_UNORDERED_FLAG, customizer, stack) : result)) {
            return false;
          }
        }
      }
...
var require_property = __commonJS({
  "node_modules/@newdash/newdash/property.js"(exports) {
    ...
    function property(path) {
      return (0, isKey_1.default)(path) ? (0, baseProperty_1.default)((0, toKey_1.default)(path)) : (0, basePropertyDeep_1.default)(path);
    }
  ...
  "node_modules/@newdash/newdash/.internal/baseIteratee.js"(exports) {
    ...
    function baseIteratee(value) {
      ...
      if (typeof value == "object") {
        return (0, isArray_1.default)(value) ? (0, baseMatchesProperty_1.default)(value[0], value[1]) : (0, baseMatches_1.default)(value);
      }
...
var require_isMap = __commonJS({
  "node_modules/@newdash/newdash/isMap.js"(exports) {
    ...
    function isMap(value) {
      return (0, isObjectLike_1.default)(value) && (0, getTag_1.default)(value) == "[object Map]";
    }
    exports.isMap = isMap;
...
var require_assignValue = __commonJS({
  "node_modules/@newdash/newdash/.internal/assignValue.js"(exports) {
    ...
    function assignValue(object, key, value) {
      ...
      if (!(hasOwnProperty.call(object, key) && (0, eq_1.default)(objValue, value)) || value === void 0 && !(key in object)) {
...
var require_baseAssign = __commonJS({
  "node_modules/@newdash/newdash/.internal/baseAssign.js"(exports) {
    ...
    function baseAssign(object, source) {
      return object && (0, copyObject_1.default)(source, (0, keys_1.default)(source), object);
    }
...
var require_baseAssignIn = __commonJS({
  "node_modules/@newdash/newdash/.internal/baseAssignIn.js"(exports) {
    ...
    function baseAssignIn(object, source) {
      return object && (0, copyObject_1.default)(source, (0, keysIn_1.default)(source), object);
    }
...
var require_cloneBuffer = __commonJS({
  "node_modules/@newdash/newdash/.internal/cloneBuffer.js"(exports, module2) {
    ...
    var freeModule = freeExports && typeof module2 === "object" && module2 !== null && !module2.nodeType && module2;
...
var require_cloneDataView = __commonJS({
  "node_modules/@newdash/newdash/.internal/cloneDataView.js"(exports) {
    ...
    function cloneDataView(dataView, isDeep) {
      const buffer = isDeep ? (0, cloneArrayBuffer_1.default)(dataView.buffer) : dataView.buffer;
...
var require_cloneTypedArray = __commonJS({
  "node_modules/@newdash/newdash/.internal/cloneTypedArray.js"(exports) {
    ...
    function cloneTypedArray(typedArray, isDeep) {
      const buffer = isDeep ? (0, cloneArrayBuffer_1.default)(typedArray.buffer) : typedArray.buffer;
...
var require_copySymbols = __commonJS({
  "node_modules/@newdash/newdash/.internal/copySymbols.js"(exports) {
    ...
    function copySymbols(source, object) {
      return (0, copyObject_1.default)(source, (0, getSymbols_1.default)(source), object);
    }
...
var require_copySymbolsIn = __commonJS({
  "node_modules/@newdash/newdash/.internal/copySymbolsIn.js"(exports) {
    ...
    function copySymbolsIn(source, object) {
      return (0, copyObject_1.default)(source, (0, getSymbolsIn_1.default)(source), object);
    }
...
var require_initCloneObject = __commonJS({
  "node_modules/@newdash/newdash/.internal/initCloneObject.js"(exports) {
    ...
    function initCloneObject(object) {
      return typeof object.constructor === "function" && !(0, isPrototype_1.default)(object) ? Object.create(Object.getPrototypeOf(object)) : {};
    }
    ...
    function baseClone(value, bitmask, customizer, key, object, stack) {
      ...
      if (isArr) {
        ...
        if (tag == objectTag || tag == argsTag || isFunc && !object) {
          ...
          if (!isDeep) {
            return isFlat ? (0, copySymbolsIn_1.default)(value, (0, baseAssignIn_1.default)(result, value)) : (0, copySymbols_1.default)(value, (0, baseAssign_1.default)(result, value));
          }
        } else {
      ...
      var keysFunc = isFull ? isFlat ? getAllKeysIn_1.default : getAllKeys_1.default : isFlat ? keysIn_1.default : keys_1.default;
      ...
      (0, arrayEach_1.default)(props || value, function(subValue, key2) {
        ...
        (0, assignValue_1.default)(result, key2, baseClone(subValue, bitmask, customizer, key2, value, stack));
      });
      return result;
    }
...
var require_iteratee = __commonJS({
  "node_modules/@newdash/newdash/iteratee.js"(exports) {
    ...
    function iteratee(func) {
      return (0, baseIteratee_1.default)(typeof func == "function" ? func : (0, baseClone_1.default)(func, CLONE_DEEP_FLAG));
    }
...
var require_forEach = __commonJS({
  "node_modules/@newdash/newdash/forEach.js"(exports) {
    ...
    function forEach2(collection, iteratee) {
      const func = Array.isArray(collection) ? arrayEach_1.default : baseEach_1.default;
...
var require_enum = __commonJS({
  "node_modules/@odata/metadata/lib/enum.js"(exports) {
    ...
    (function(PrimitiveTypeEnum2) {
      ...
      PrimitiveTypeEnum2["GeographyMultiLineString"] = "Edm.GeographyMultiLineString";
      ...
      PrimitiveTypeEnum2["GeometryMultiLineString"] = "Edm.GeometryMultiLineString";
...
var require_edm = __commonJS({
  "node_modules/@odata/metadata/lib/edm.js"(exports) {
    ...
    (function(Edm5) {
      ...
      Edm5.GeographyMultiLineString = new PrimitiveType("Edm.GeographyMultiLineString");
      Edm5.GeographyMultiPolygon = new PrimitiveType("Edm.GeographyMultiPolygon");
      ...
      Edm5.GeometryMultiLineString = new PrimitiveType("Edm.GeometryMultiLineString");
      ...
      __decorate([
        parseAs(new AttributeFunctionChain((d, i) => d.key, (props, i) => props !== null && props !== void 0 ? props : [], (props, i) => {
          var _a;
          return (_a = props === null || props === void 0 ? void 0 : props.map) === null || _a === void 0 ? void 0 : _a.call(props, (prop) => new Key(prop, i));
        }, (props) => props === null || props === void 0 ? void 0 : props[0])),
      ...
      __decorate([
        ...
        required2,
        __metadata("design:type", String)
      ], Function2.prototype, "name", void 0);
      __decorate([
        parse,
        __metadata("design:type", Boolean)
      ], Function2.prototype, "isBound", void 0);
      __decorate([
        parse,
        __metadata("design:type", String)
      ], Function2.prototype, "entitySetPath", void 0);
      __decorate([
        jsonProperty("parameter"),
        parseAs(mapArray("parameter", (prop, i) => new Parameter(prop, i))),
        __metadata("design:type", Array)
      ], Function2.prototype, "parameters", void 0);
      __decorate([
        parseAs(new AttributeFunctionChain((d, i) => d.returnType, (rt, i) => new ReturnType(rt, i))),
        __metadata("design:type", ReturnType)
      ], Function2.prototype, "returnType", void 0);
      __decorate([
        parse,
        __metadata("design:type", Boolean)
      ], Function2.prototype, "isComposable", void 0);
      __decorate([
        jsonProperty("annotation"),
        parseAs(mapArray("annotation", (prop, i) => new (annotationTypeSelector(prop))(prop, i))),
        __metadata("design:type", Array)
      ], Function2.prototype, "annotations", void 0);
      ...
      __decorate([
        ...
        parseAs(mapArray("function", (prop, i) => new Edm5.Function(prop, i))),
        __metadata("design:type", Array)
      ], Schema.prototype, "functions", void 0);
      __decorate([
        jsonProperty("entityContainer"),
        parseAs(mapArray("entityContainer", (prop, i) => new Edm5.EntityContainer(prop, i))),
        __metadata("design:type", Array)
      ], Schema.prototype, "entityContainer", void 0);
      __decorate([
        jsonProperty("annotations"),
        parseAs(mapArray("annotations", (prop, i) => new Edm5.Annotations(prop, i))),
        __metadata("design:type", Array)
      ...
      __decorate([
        parseAs(new AttributeFunctionChain((edm) => new Edm5.DataServices(edm.dataServices))),
    ...
    (function(Xml2) {
      class XmlCreator {
        ...
        addNamespace(namespace2) {
          if (this.currentElement.InheritedNamespaces.indexOf(namespace2.Name) === -1 && this.currentElement.Namespaces.indexOf(namespace2.Name) === -1) {
    ...
    var XmlMetadata = class {
      ...
      buildSchema(xml, schemas) {
        schemas && schemas.forEach((schema) => {
          ...
          xml.startElement(schemaElement).addAttribute(xmlns, this.options.namespace).addAttribute(ns, schema.namespace || this.options.contextNamespace);
          if (schema.alias) {
      ...
      buildTypeNavigationProperties(xml, navigationProperties) {
        navigationProperties && navigationProperties.forEach((navigationProperty2) => {
          const navigationPropertyElement = xml.declareElement("NavigationProperty");
          xml.startElement(navigationPropertyElement);
          this.buildAttributes(xml, navigationProperty2, this.typeNavigationPropertyAttributes);
          this.buildNavPropertyReferentialConstraints(xml, navigationProperty2.referentialConstraints);
      ...
      buildActions(xml, actions) {
        actions && actions.forEach((action2) => {
          ...
          if (typeof action2.isBound !== "undefined") {
            xml.addAttribute(xml.declareAttribute("IsBound"), action2.isBound.toString());
          }
          if (action2.entitySetPath) {
            xml.addAttribute(xml.declareAttribute("EntitySetPath"), action2.entitySetPath);
          }
      ...
      buildActionImports(xml, actionImports) {
        actionImports && actionImports.forEach((actionImport2) => {
          const actionImportElement = xml.declareElement("ActionImport");
          const name = xml.declareAttribute("Name");
          const action2 = xml.declareAttribute("Action");
          xml.startElement(actionImportElement).addAttribute(name, actionImport2.name).addAttribute(action2, actionImport2.action);
...
var require_lib = __commonJS({
  "node_modules/@odata/metadata/lib/index.js"(exports) {
    ...
    var enum_1 = require_enum();
    Object.defineProperty(exports, "PrimitiveTypeEnum", { enumerable: true, get: function() {
...
var require_isFlattenable = __commonJS({
  "node_modules/@newdash/newdash/.internal/isFlattenable.js"(exports) {
    ...
    function isFlattenable(value) {
      return Array.isArray(value) || (0, isArguments_1.default)(value) || !!(value && value[spreadableSymbol]);
    }
...
var require_baseIndexOf = __commonJS({
  "node_modules/@newdash/newdash/.internal/baseIndexOf.js"(exports) {
    ...
    function baseIndexOf(array, value, fromIndex) {
      return value === value ? (0, strictIndexOf_1.default)(array, value, fromIndex) : (0, baseFindIndex_1.default)(array, baseIsNaN_1.default, fromIndex);
    }
...
var require_createSet = __commonJS({
  "node_modules/@newdash/newdash/.internal/createSet.js"(exports) {
    ...
    var setToArray_1 = __importDefault(require_setToArray());
    var INFINITY = 1 / 0;
    var createSet = Set && 1 / (0, setToArray_1.default)(/* @__PURE__ */ new Set([, -0]))[1] == INFINITY ? (values) => new Set(values) : () => {
    };
...
var require_uniq = __commonJS({
  "node_modules/@newdash/newdash/uniq.js"(exports) {
    ...
    function uniq2(array) {
      return array != null && array.length ? (0, baseUniq_1.default)(array) : [];
    }
    exports.uniq = uniq2;
...
function traverseAst(traverser, node, parent) {
  ...
  if ((0, import_isArray.isArray)(node == null ? void 0 : node.value) || (0, import_isPlainObject.isPlainObject)(node == null ? void 0 : node.value)) {
  ...
  if ((0, import_isArray.isArray)((_a = node == null ? void 0 : node.value) == null ? void 0 : _a.options)) {
    (0, import_forEach.forEach)((_b = node == null ? void 0 : node.value) == null ? void 0 : _b.options, (item) => {
      if (item instanceof Token) {
        traverseAst(traverser, item, node);
      }
    });
  }
  if ((0, import_isArray.isArray)((_c = node == null ? void 0 : node.value) == null ? void 0 : _c.items)) {
    (0, import_forEach.forEach)((_d = node == null ? void 0 : node.value) == null ? void 0 : _d.items, (item) => {
      if (item instanceof Token) {
        traverseAst(traverser, item, node);
      }
    });
...
function stringify(value, index, next) {
  return (0, import_map.map)(value.slice(index, next), (ch) => String.fromCharCode(ch)).join(
    ""
  );
}
...
var TokenType2 = /* @__PURE__ */ ((TokenType3) => {
  ...
  TokenType3["EntityCollectionNavigationProperty"] = "EntityCollectionNavigationProperty";
  ...
  TokenType3["EntityCollectionFunctionImport"] = "EntityCollectionFunctionImport";
  TokenType3["ComplexFunctionImport"] = "ComplexFunctionImport";
  TokenType3["ComplexCollectionFunctionImport"] = "ComplexCollectionFunctionImport";
  TokenType3["PrimitiveFunctionImport"] = "PrimitiveFunctionImport";
  TokenType3["PrimitiveCollectionFunctionImport"] = "PrimitiveCollectionFunctionImport";
  ...
  TokenType3["CollectionNavigationExpression"] = "CollectionNavigationExpression";
  ...
  TokenType3["EntityCollectionFunctionImportCall"] = "EntityCollectionFunctionImportCall";
  TokenType3["EntityFunctionImportCall"] = "EntityFunctionImportCall";
  TokenType3["ComplexCollectionFunctionImportCall"] = "ComplexCollectionFunctionImportCall";
  TokenType3["ComplexFunctionImportCall"] = "ComplexFunctionImportCall";
  TokenType3["PrimitiveCollectionFunctionImportCall"] = "PrimitiveCollectionFunctionImportCall";
  ...
  TokenType3["BoundEntityCollectionFunctionCall"] = "BoundEntityCollectionFunctionCall";
  TokenType3["BoundComplexFunctionCall"] = "BoundComplexFunctionCall";
  TokenType3["BoundComplexCollectionFunctionCall"] = "BoundComplexCollectionFunctionCall";
  TokenType3["BoundPrimitiveFunctionCall"] = "BoundPrimitiveFunctionCall";
  TokenType3["BoundPrimitiveCollectionFunctionCall"] = "BoundPrimitiveCollectionFunctionCall";
...
function ALPHA(value) {
  return value >= 65 && value <= 90 || value >= 97 && value <= 122 || value >= 128;
}
...
function whitespaceLength(value, index) {
  if (utils_default.equals(value, index, "%20") || utils_default.equals(value, index, "%09")) {
    return 3;
  } else if (SP(value[index]) || HTAB(value[index]) || value[index] === 32 || value[index] === 9) {
    return 1;
  }
}
...
function unreserved(value) {
  return ALPHA(value) || DIGIT(value) || value === 45 || value === 46 || value === 95 || value === 126;
}
...
function pctEncoded(value, index) {
  if (value[index] !== 37 || !HEXDIG(value[index + 1]) || !HEXDIG(value[index + 2])) {
    return index;
  }
  return index + 3;
}
...
function pctEncodedUnescaped(value, index) {
  if (utils_default.equals(value, index, "%22") || utils_default.equals(value, index, "%3") || utils_default.equals(value, index, "%4") || utils_default.equals(value, index, "%5C")) {
    return index;
  }
  return pctEncoded(value, index);
}
...
function qcharNoAMP(value, index) {
  if (unreserved(value[index]) || value[index] === 58 || value[index] === 64 || value[index] === 47 || value[index] === 63 || value[index] === 36 || value[index] === 39 || value[index] === 61) {
    return index + 1;
  }
...
function base64b8(value, index) {
  ...
  index++;
  if (value[index] !== 65 || value[index] !== 81 || value[index] !== 103 || value[index] !== 119) {
    return start;
  }
  index++;
...
function nanInfinity(value, index) {
  return utils_default.equals(value, index, "NaN") || utils_default.equals(value, index, "-INF") || utils_default.equals(value, index, "INF");
}
...
function year(value, index) {
  ...
  if (value[index] === 48 && (end = utils_default.required(value, index + 1, DIGIT, 3, 3)) || oneToNine(value[index]) && (end = utils_default.required(value, index + 1, DIGIT, 3))) {
    return end;
  }
  return start;
}
function month(value, index) {
  if (value[index] === 48 && oneToNine(value[index + 1]) || value[index] === 49 && value[index + 1] >= 48 && value[index + 1] <= 50) {
    return index + 2;
  }
  return index;
}
function day(value, index) {
  if (value[index] === 48 && oneToNine(value[index + 1]) || (value[index] === 49 || value[index] === 50) && DIGIT(value[index + 1]) || value[index] === 51 && (value[index + 1] === 48 || value[index + 1] === 49)) {
    return index + 2;
  }
  return index;
}
function hour(value, index) {
  if ((value[index] === 48 || value[index] === 49) && DIGIT(value[index + 1]) || value[index] === 50 && (value[index + 1] === 48 || value[index + 1] === 49 || value[index + 1] === 50 || value[index + 1] === 51)) {
    return index + 2;
  }
  return index;
}
...
function guidValue(value, index) {
  if (utils_default.required(value, index, HEXDIG, 8, 8) && value[index + 8] === 45 && utils_default.required(value, index + 9, HEXDIG, 4, 4) && value[index + 13] === 45 && utils_default.required(value, index + 14, HEXDIG, 4, 4) && value[index + 18] === 45 && utils_default.required(value, index + 19, HEXDIG, 4, 4) && value[index + 23] === 45 && utils_default.required(value, index + 24, HEXDIG, 12)) {
    return tokenize(
      value,
      index,
      index + 36,
...
function int64Value(value, index) {
  ...
  if (next) {
    ...
    if (val >= "0" && val <= (value[start] === 45 ? "9223372036854775808" : "9223372036854775807")) {
      return tokenize(
        value,
        start,
        next,
    ...
    while (index < value.length) {
      ...
      if (squote) {
        ...
        if (!squote) {
          ...
          if (pcharNoSQUOTE(value, index) > index && !amp && !close && !comma && RWS(value, index) === index) {
            return;
          }
          break;
        } else {
  ...
  if (value[index] === 84) {
    ...
    const parseTimeFn = function() {
      ...
      if (value[index] === 83) {
        ...
        if (fractionalSecondsNext === index || value[fractionalSecondsNext] !== 83) {
          return;
        }
...
function binaryValue(value, index) {
  ...
  while (index < value.length && !(squote = SQUOTE(value, index))) {
    const end = Math.max(
      base64b16(value, index),
      base64b8(value, index)
    );
    if (end > index) {
      index = end;
    } else if (base64char(value[index]) && base64char(value[index + 1]) && base64char(value[index + 2]) && base64char(value[index + 3])) {
      index += 4;
    } else {
      index++;
    }
...
function dateTimeOffsetValue(value, index) {
  ...
  if (colon) {
    ...
    if (value[secondNext] === 46) {
      const fractionalSecondsNext = fractionalSeconds(
        value,
        secondNext + 1
      );
...
function pointLiteral(value, index) {
  if (!(utils_default.equals(value, index, "Point") || utils_default.equals(value, index, "POINT"))) {
    return;
  }
  const start = index;
  index += 5;
...
function polygonLiteral(value, index) {
  if (!(utils_default.equals(value, index, "Polygon") || utils_default.equals(value, index, "POLYGON"))) {
    return;
  }
  const start = index;
  index += 7;
...
function geoLiteral(value, index) {
  return collectionLiteral(value, index) || lineStringLiteral(value, index) || multiPointLiteral(value, index) || multiLineStringLiteral(value, index) || multiPolygonLiteral(value, index) || pointLiteral(value, index) || polygonLiteral(value, index);
}
...
function geographyPoint(value, index) {
  return geoLiteralFactory(value, index, "Edm.GeographyPoint", geographyPrefix, fullPointLiteral) || geoLiteralFactory(value, index, "Edm.GeographyPoint", geographyPrefix, pointLiteral);
}
...
function primitiveLiteral(value, index) {
  return nullValue(value, index) || booleanValue(value, index) || guidValue(value, index) || dateValue(value, index) || dateTimeOffsetValue(value, index) || timeOfDayValue(value, index) || decimalValue(value, index) || doubleValue(value, index) || singleValue(value, index) || sbyteValue(value, index) || byteValue(value, index) || int16Value(value, index) || int32Value(value, index) || int64Value(value, index) || stringValue(value, index) || durationValue(value, index) || binaryValue(value, index) || enumeration(value, index) || geographyCollection(value, index) || geographyLineString(value, index) || geographyMultiLineString(value, index) || geographyMultiPoint(value, index) || geographyMultiPolygon(value, index) || geographyPoint(value, index) || geographyPolygon(value, index) || geometryCollection(value, index) || geometryLineString(value, index) || geometryMultiLineString(value, index) || geometryMultiPoint(value, index) || geometryMultiPolygon(value, index) || geometryPoint(value, index) || geometryPolygon(value, index);
}
...
function singleQualifiedTypeName(value, index) {
  return qualifiedEntityTypeName(value, index) || qualifiedComplexTypeName(value, index) || qualifiedTypeDefinitionName(value, index) || qualifiedEnumTypeName(value, index) || primitiveTypeName(value, index);
}
...
function qualifiedEntityTypeName(value, index, metadataContext) {
  ...
  if (typeof metadataContext === "object") {
    schema = getMetadataRoot(metadataContext).schemas.filter(
      (it) => it.namespace === utils_default.stringify(value, start, namespaceNext)
    )[0];
  }
...
function odataIdentifier(value, index, tokenType) {
  ...
  if (identifierLeadingCharacter(value[index])) {
    index++;
    while (index < value.length && index - start < 128 && identifierCharacter(value[index])) {
      index++;
    }
  }
  if (index > start) {
...
function entitySetName(value, index, metadataContext) {
  const token = odataIdentifier(value, index, "EntitySetName" /* EntitySetName */);
  if (!token) {
    return;
  }
  if (typeof metadataContext === "object") {
    ...
    metadataContext.dataServices.schemas.forEach(
      (schema) => schema.entityContainer.forEach(
        (container) => container.entitySets.filter((set) => {
    ...
    let entityType;
    metadataContext.dataServices.schemas.forEach(
      (schema) => entitySet.entityType.indexOf(`${schema.namespace}.`) === 0 && schema.entityTypes.filter((type) => {
...
function entityTypeName(value, index, schema) {
  const token = odataIdentifier(value, index, "EntityTypeName" /* EntityTypeName */);
  if (!token) {
    return;
  }
...
function complexTypeName(value, index, schema) {
  const token = odataIdentifier(value, index, "ComplexTypeName" /* ComplexTypeName */);
  if (!token) {
    return;
  }
  if (typeof schema === "object") {
...
function typeDefinitionName(value, index) {
  return odataIdentifier(value, index, "TypeDefinitionName" /* TypeDefinitionName */);
}
function enumerationTypeName(value, index) {
  return odataIdentifier(value, index, "EnumerationTypeName" /* EnumerationTypeName */);
}
function enumerationMember(value, index) {
  return odataIdentifier(value, index, "EnumerationMember" /* EnumerationMember */);
}
...
function primitiveTypeName(value, index) {
  ...
  const start = index;
  index += 4;
  const end = index + (utils_default.equals(value, index, "Binary") || utils_default.equals(value, index, "Boolean") || utils_default.equals(value, index, "Byte") || utils_default.equals(value, index, "Date") || utils_default.equals(value, index, "DateTimeOffset") || utils_default.equals(value, index, "Decimal") || utils_default.equals(value, index, "Double") || utils_default.equals(value, index, "Duration") || utils_default.equals(value, index, "Guid") || utils_default.equals(value, index, "Int16") || utils_default.equals(value, index, "Int32") || utils_default.equals(value, index, "Int64") || utils_default.equals(value, index, "SByte") || utils_default.equals(value, index, "Single") || utils_default.equals(value, index, "Stream") || utils_default.equals(value, index, "String") || utils_default.equals(value, index, "TimeOfDay") || utils_default.equals(value, index, "GeographyCollection") || utils_default.equals(value, index, "GeographyLineString") || utils_default.equals(value, index, "GeographyMultiLineString") || utils_default.equals(value, index, "GeographyMultiPoint") || utils_default.equals(value, index, "GeographyMultiPolygon") || utils_default.equals(value, index, "GeographyPoint") || utils_default.equals(value, index, "GeographyPolygon") || utils_default.equals(value, index, "GeometryCollection") || utils_default.equals(value, index, "GeometryLineString") || utils_default.equals(value, index, "GeometryMultiLineString") || utils_default.equals(value, index, "GeometryMultiPoint") || utils_default.equals(value, index, "GeometryMultiPolygon") || utils_default.equals(value, index, "GeometryPoint") || utils_default.equals(value, index, "GeometryPolygon"));
  if (end > index) {
    return tokenize(
      value,
      start,
...
function isPrimitiveTypeName(type, metadataContext) {
  ...
  if (schema) {
    return (schema.enumTypes && schema.enumTypes.filter(
      (it) => it.name === type.split(".").pop()
    )[0] || schema.typeDefinitions && schema.typeDefinitions.filter(
      (it) => it.name === type.split(".").pop()
    )[0]) && !(schema.entityTypes && schema.entityTypes.filter(
      (it) => it.name === type.split(".").pop()
    )[0] || schema.complexTypes && schema.complexTypes.filter(
      (it) => it.name === type.split(".").pop()
    )[0]);
  }
...
function primitiveKeyProperty(value, index, metadataContext) {
  ...
  if (token && token.type === "PrimitiveKeyProperty" /* PrimitiveKeyProperty */) {
    return token;
  }
}
...
function complexProperty(value, index, metadataContext) {
  const token = odataIdentifier(value, index, "ComplexProperty" /* ComplexProperty */);
  if (!token) {
    return;
  }
  if (typeof metadataContext === "object") {
...
function streamProperty(value, index, metadataContext) {
  const token = odataIdentifier(value, index, "StreamProperty" /* StreamProperty */);
  if (!token) {
    return;
  }
  if (typeof metadataContext === "object") {
...
function navigationProperty(value, index, metadataContext) {
  return entityNavigationProperty(value, index, metadataContext) || entityColNavigationProperty(value, index, metadataContext);
}
...
function actionImport(value, index, metadataContext) {
  const token = odataIdentifier(value, index, "ActionImport" /* ActionImport */);
  if (!token) {
    return;
  }
  if (typeof metadataContext === "object") {
...
function odataFunction(value, index) {
  return entityFunction(value, index) || entityColFunction(value, index) || complexFunction(value, index) || complexColFunction(value, index) || primitiveFunction(value, index) || primitiveColFunction(value, index);
}
    ...
    for (let j = 0; j < schema[`${operation}s`].length; j++) {
      ...
      if (fn.name === token.raw && fn.isBound) {
        for (let k = 0; k < fn.parameters.length; k++) {
          ...
          if (param2.name === "bindingParameter" && param2.type === bindingParameterType) {
            fnDef = fn;
            break;
          }
        }
...
function entityFunction(value, index, isCollection, metadataContext) {
  const token = odataIdentifier(value, index, "EntityFunction" /* EntityFunction */);
  if (!token) {
    return;
  }
  if (typeof metadataContext === "object") {
...
function complexFunction(value, index, isCollection, metadataContext) {
  const token = odataIdentifier(value, index, "ComplexFunction" /* ComplexFunction */);
  if (!token) {
    return;
  }
  if (typeof metadataContext === "object") {
...
function collectionPropertyInUri(value, index) {
  ...
  const start = index;
  index = mark;
  const prop = primitiveColProperty(value, index) || complexColProperty(value, index);
  if (!prop) {
    return;
  }
  index = prop.next;
  ...
  index = separator;
  const propValue = prop.type === "PrimitiveCollectionProperty" /* PrimitiveCollectionProperty */ ? primitiveColInUri(value, index) : complexColInUri(value, index);
  if (!propValue) {
    return;
  }
...
function annotationInUri(value, index) {
  ...
  return tokenize(
    ...
    index,
    {
      key: `@${utils_default.stringify(value, namespaceStart, namespaceNext)}.${term.raw}`,
      value: token
    },
...
function charInJSON(value, index) {
  ...
  if (escape2 > index) {
    ...
    if (utils_default.equals(value, escape2, "/") || utils_default.equals(value, escape2, "b") || utils_default.equals(value, escape2, "f") || utils_default.equals(value, escape2, "n") || utils_default.equals(value, escape2, "r") || utils_default.equals(value, escape2, "t")) {
      return escape2 + 1;
    }
    if (utils_default.equals(value, escape2, "u") && utils_default.required(value, escape2 + 1, HEXDIG, 4, 4)) {
      return escape2 + 5;
    }
...
function commonExpr(value, index) {
  const token = primitiveLiteral(value, index) || parameterAlias(value, index) || arrayOrObject(value, index) || rootExpr(value, index) || methodCallExpr(value, index) || firstMemberExpr(value, index) || functionExpr(value, index) || negateExpr(value, index) || parenExpr(value, index) || castExpr(value, index);
  if (!token) {
    return;
  }
  const expr = addExpr(value, token.next) || subExpr(value, token.next) || mulExpr(value, token.next) || divExpr(value, token.next) || modExpr(value, token.next);
  if (expr) {
    token.value = {
      left: clone(token),
      right: expr.value
...
function boolCommonExpr(value, index) {
  const token = isofExpr(value, index) || boolMethodCallExpr(value, index) || notExpr(value, index) || commonExpr(value, index) || boolParenExpr(value, index);
  if (!token) {
    return;
  }
  let commonMoreExpr = void 0;
  if (token.type === "CommonExpression" /* CommonExpression */) {
    commonMoreExpr = eqExpr(value, token.next) || neExpr(value, token.next) || ltExpr(value, token.next) || leExpr(value, token.next) || gtExpr(value, token.next) || geExpr(value, token.next) || hasExpr(value, token.next);
    if (commonMoreExpr) {
      token.value = {
        left: token.value,
  ...
  if (expr) {
    ...
    token.type = expr.type;
    token.raw = utils_default.stringify(value, token.position, token.next);
    if (token.type === "AndExpression" /* AndExpression */ && token.value.right.type === "OrExpression" /* OrExpression */) {
...
function eqExpr(value, index) {
  return leftRightExpr(value, index, "eq", "EqualsExpression" /* EqualsExpression */);
}
function neExpr(value, index) {
  return leftRightExpr(value, index, "ne", "NotEqualsExpression" /* NotEqualsExpression */);
}
...
function hasExpr(value, index) {
  return leftRightExpr(value, index, "has", "HasExpression" /* HasExpression */);
}
function addExpr(value, index) {
  return leftRightExpr(value, index, "add", "AddExpression" /* AddExpression */);
}
function subExpr(value, index) {
  return leftRightExpr(value, index, "sub", "SubExpression" /* SubExpression */);
}
function mulExpr(value, index) {
  return leftRightExpr(value, index, "mul", "MulExpression" /* MulExpression */);
}
function divExpr(value, index) {
  return leftRightExpr(value, index, "div", "DivExpression" /* DivExpression */);
}
function modExpr(value, index) {
  return leftRightExpr(value, index, "mod", "ModExpression" /* ModExpression */);
}
...
function propertyPathExpr(value, index) {
  ...
  if (token) {
    index = token.next;
    const nav = collectionPathExpr(value, token.next) || collectionNavigationExpr(value, token.next) || singleNavigationExpr(value, token.next) || complexPathExpr(value, token.next) || singlePathExpr(value, token.next);
    if (nav) {
      index = nav.next;
      token = {
        current: clone(token),
...
function inscopeVariableExpr(value, index) {
  return implicitVariableExpr(value, index) || (isLambdaPredicate ? lambdaVariableExpr(value, index) : void 0);
}
...
function keyValuePair(value, index) {
  const prop = primitiveKeyProperty(value, index) || keyPropertyAlias(value, index);
  if (!prop) {
    return;
  }
...
function functionExpr(value, index) {
  ...
  index = params.next;
  const expr = collectionPathExpr(value, index) || collectionNavigationExpr(value, index) || singleNavigationExpr(value, index) || complexPathExpr(value, index) || singlePathExpr(value, index);
  if (expr) {
    index = expr.next;
  }
  return tokenize(
...
function expandPath(value, index, metadataContext) {
  const start = index;
  const path = [];
  const token = qualifiedEntityTypeName(value, index, metadataContext) || qualifiedComplexTypeName(value, index, metadataContext);
  if (token) {
    index = token.next;
    path.push(token);
    if (value[index] !== 47) {
  ...
  let complex = complexProperty(value, index, metadataContext) || complexColProperty(value, index, metadataContext);
  while (complex) {
    if (value[complex.next] === 47) {
      ...
      complex = complexProperty(value, index, metadataContext) || complexColProperty(value, index, metadataContext);
    } else {
      break;
    }
  }
  const nav = navigationProperty(
    value,
    index,
    metadataContext
  );
  ...
  delete nav.metadata;
  if (value[index] === 47) {
    const typeName = qualifiedEntityTypeName(
      value,
      index + 1,
      metadataContext
    );
...
function searchExpr(value, index) {
  ...
  if (expr) {
    ...
    token.type = expr.type;
    token.raw = utils_default.stringify(value, token.position, token.next);
    if (token.type === "SearchAndExpression" /* SearchAndExpression */ && token.value.right.type === "SearchOrExpression" /* SearchOrExpression */) {
      token.value.left = tokenize(
        value,
        token.value.left.position,
        token.value.right.value.left.next,
...
function selectItem(value, index) {
  ...
  const star = STAR(value, index);
  if (op > index) {
    item = { namespace: utils_default.stringify(value, index, op - 2), value: "*" };
    index = op;
  } else if (star) {
    item = { value: "*" };
    index = star;
    ...
    item = {};
    const name = qualifiedEntityTypeName(value, index) || qualifiedComplexTypeName(value, index);
    ...
    const select2 = selectProperty(value, index) || qualifiedActionName(value, index) || qualifiedFunctionName(value, index);
    if (!select2) {
      return;
    }
    index = select2.next;
...
function selectProperty(value, index) {
  const token = selectPath(value, index) || primitiveProperty(value, index) || primitiveColProperty(value, index) || navigationProperty(value, index);
  if (!token) {
    return;
  }
  const start = index;
...
function selectPath(value, index) {
  const token = complexProperty(value, index) || complexColProperty(value, index);
  if (!token) {
    return;
  }
  const start = index;
...
function qualifiedActionName(value, index) {
  ...
  action2.value.namespace = utils_default.stringify(value, start, namespaceNext);
  return tokenize(
    value,
    start,
    action2.next,
...
function resourcePath(value, index, metadataContext) {
  ...
  const resource = entitySetName(value, index, metadataContext) || functionImportCall(value, index, metadataContext) || crossjoin(value, index) || all(value, index) || actionImportCall(value, index, metadataContext) || singletonEntity(value, index);
  if (!resource) {
    return;
  }
  const start = index;
...
function collectionNavigationPath(value, index, metadataContext) {
  const start = index;
  const token = collectionPath(value, index, metadataContext) || refExpr(value, index);
  if (token) {
    return token;
  }
...
function singleNavigation(value, index, metadataContext) {
  let token = boundOperation(value, index, false, metadataContext) || refExpr(value, index) || valueExpr(value, index);
  if (token) {
    return token;
  }
  const start = index;
...
function propertyPath(value, index, metadataContext) {
  const token = entityColNavigationProperty(
    value,
    index,
    metadataContext
  ) || entityNavigationProperty(value, index, metadataContext) || complexColProperty(value, index, metadataContext) || complexProperty(value, index, metadataContext) || primitiveColProperty(value, index, metadataContext) || primitiveProperty(value, index, metadataContext) || streamProperty(value, index, metadataContext);
  if (!token) {
    return;
  }
  const start = index;
...
function collectionPath(value, index, metadataContext) {
  return countExpr(value, index) || boundOperation(value, index, true, metadataContext);
}
function singlePath(value, index, metadataContext) {
  return valueExpr(value, index) || boundOperation(value, index, false, metadataContext);
}
...
function boundFunctionCall(value, index, odataFunction2, tokenType, isCollection, metadataContext) {
  const namespaceNext = namespace(value, index);
  if (namespaceNext === index) {
    return;
  }
...
function functionImportCall(value, index, metadataContext) {
  const fnImport = entityFunctionImport(value, index, metadataContext) || entityColFunctionImport(value, index, metadataContext) || complexFunctionImport(value, index, metadataContext) || complexColFunctionImport(value, index, metadataContext) || primitiveFunctionImport(value, index, metadataContext) || primitiveColFunctionImport(value, index, metadataContext);
  if (!fnImport) {
    return;
  }
  const start = index;
...
function convertPrimitiveValueToString(value, version = "v4") {
  var _a, _b, _c;
  if (((_a = value == null ? void 0 : value.getValue) == null ? void 0 : _a.call(value)) === null) {
    return "null";
  }
  if (((_b = value == null ? void 0 : value.getValue) == null ? void 0 : _b.call(value)) !== void 0) {
    switch ((_c = value == null ? void 0 : value.getType) == null ? void 0 : _c.call(value)) {
  ...
  _buildExprLit(value, version = "v4") {
    ...
    switch (typeof value) {
      ...
      case "object":
        ...
        throw new Error(
          `Not support object ${((_a = value == null ? void 0 : value.constructor) == null ? void 0 : _a.name) || typeof value} in odata filter eq/ne/gt/ge/ne/nt ...`
        );
      case "undefined":
        throw new Error(
          `You must set value in odata filter eq/ne/gt/ge/ne/nt ...`
    ...
    if (exprs.length > 0) {
      if (exprs.filter((expr) => expr.op == "eq" /* eq */).length == 0) {
        return `(${(0, import_join.default)(
          exprs.map(
            ({ op, value }) => `${field} ${op} ${this._buildExprLit(value, version)}`
          ),
          " and "
        )})`;
      }
...
var ODataQueryParam = class _ODataQueryParam {
  ...
  toString(version = "v4") {
    ...
    if (this.$select && this.$select.length > 0) {
      rt.append("$select", (0, import_join2.default)((0, import_uniq.default)(this.$select), ","));
    }
    if (this.$skip) {
...
var literalValues = {
  ...
  DateTimeOffset: (value) => import_metadata3.Edm.DateTimeOffset.createValue(value),
  ...
  GeographyPoint: (value) => import_metadata3.Edm.GeographyPoint.createValue(value),
  GeographyLineString: (value) => import_metadata3.Edm.GeographyLineString.createValue(value),
  GeographyPolygon: (value) => import_metadata3.Edm.GeographyPolygon.createValue(value),
  GeographyMultiPoint: (value) => import_metadata3.Edm.GeographyMultiPoint.createValue(value),
  GeographyMultiLineString: (value) => import_metadata3.Edm.GeographyMultiLineString.createValue(value),
  GeographyMultiPolygon: (value) => import_metadata3.Edm.GeographyMultiPolygon.createValue(value),
  GeographyCollection: (value) => import_metadata3.Edm.GeographyCollection.createValue(value),
  Geometry: (value) => import_metadata3.Edm.Geometry.createValue(value),
  GeometryPoint: (value) => import_metadata3.Edm.GeometryPoint.createValue(value),
  GeometryLineString: (value) => import_metadata3.Edm.GeometryLineString.createValue(value),
  GeometryPolygon: (value) => import_metadata3.Edm.GeometryPolygon.createValue(value),
  GeometryMultiPoint: (value) => import_metadata3.Edm.GeometryMultiPoint.createValue(value),
  GeometryMultiLineString: (value) => import_metadata3.Edm.GeometryMultiLineString.createValue(value),
  GeometryMultiPolygon: (value) => import_metadata3.Edm.GeometryMultiPolygon.createValue(value),
  GeometryCollection: (value) => import_metadata3.Edm.GeometryCollection.createValue(value)
};
