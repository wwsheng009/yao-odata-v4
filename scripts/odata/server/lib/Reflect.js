...
(function (Reflect) {
  ...
  (function (factory) {
     ...
     * 此方法由ts运行时调用。
     * @param decorators An array of decorators.修饰器列表。
     * @param target The target object.目标对象。
     * @param propertyKey (Optional) The property key to decorate.属性
     * @param attributes (Optional) The property descriptor for the target key.
     * @remarks Decorators are applied in reverse order.作业顺序是反的。
     * @example
     *
     *     class Example {
